...
subj_IDs=[pd.read_csv('gs://data_changeparams/{}'.format(x)) for x in csv_file_names]
...
gcs.bucket('output_changeparams').blob('iter_changeparams_{}.csv'.format(np.random.randint(10000000000))).upload_from_filename('local_file.csv', content_type='text/csv')
