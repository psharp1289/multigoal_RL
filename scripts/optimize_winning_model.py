...
def opt_group_level(parameters):
	...
	likelihoods=average_rewards[0]

	return np.sum(likelihoods)

results=mins(opt_group_level,np.array([0.,1.,0.,1.,1,1,1,1,2,3,3,1,3,1,2,1]),
bounds=[(-100,100),(0,100),(-100,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100),(0,100)],
method='trust-constr',
