...
function task(uid){
    ...
    var anx_aro_q = {
      type: 'survey-likert',
      preamble:'Below is a list of feelings, sensations, problems, and experiences that people sometimes have. Read each item and then click the number that best describes how much you have felt or experienced things this way during the past week, including today.',
      questions: [
        {prompt: "Was short of breath", name: 'aa1', labels: scale_1,required: true},
        {prompt: "Felt dizzy or lightheaded", name: 'aa2', labels: scale_1,required: true},
        {prompt: "Hands were cold or sweaty", name: 'aa3', labels: scale_1,required: true},
        {prompt: "Hands were shaky", name: 'aa4', labels: scale_1,required: true},
        {prompt: "Had trouble swallowing", name: 'aa5', labels: scale_1,required: true},
        {prompt: "Had hot or cold spells", name: 'aa6', labels: scale_1,required: true},
        {prompt: "Felt like I was choking", name: 'aa7', labels: scale_1,required: true},
        {prompt: "Muscles twitched or trembled", name: 'aa8', labels: scale_1,required: true},
