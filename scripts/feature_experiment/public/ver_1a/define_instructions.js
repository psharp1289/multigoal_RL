...
for (var i = 0; i < n_practice_trials_1; i++){
  var this_trial = {
    type: 'evan-feature33',
    feature_rewards: [-6, 0, 1], // this won't be shown...
    c1_image: choice_images[0],
    c2_image: practice_image,
    c3_image: choice_images[2],
    c1_feature_probs: [1,0,1],
    c2_feature_probs: [.2,.7,.5],  ///
...
//// ...
var practice_feature_rewards = [[-3, 0, 0], [0, -1, 0], [0,0,3], [-3, 0, 0], [0, 1, 0], [0,0,3]];
...
for (var i = 0; i < n_practice_trials_2; i++){
  var this_trial = {
    ...
    c2_image: practice_image,
    c3_image: choice_images[2],
    c1_feature_probs: [.6,.3,.3], /// adjust these?
    c2_feature_probs: [.5,.5,.5],  ///
    c3_feature_probs: [.3,.3,.5],
    choice_prompt: true,
...
var questions = ["How many types of aliens are in the task?", // 1
				...
				"What does the silver number displayed on the first decision screen indicate?", // 4
...
var options4 =  ['The number of minerals that the gold alien will provide (if positive) or take away (if negative)',
								'The number of minerals that the silver alien will provide (if positive) or take away (if negative)',
								'The chances that the silver alien is behind the left door'];
var correct4 = 1;
