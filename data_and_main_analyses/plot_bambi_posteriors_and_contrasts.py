...
plt.savefig('logisticregression_switchtrialsf_empirical_cleaned.png', bbox_inches='tight',  dpi=300)
...
plt.savefig('logisticregression_switchtrials_diffs_empirical_cleaned.png', bbox_inches='tight',  dpi=300)
plt.show()
...
f.text(0.5, -.12, 'Parameter Estimate', ha='center')
f.text(0.0, 0.5, 'Density', va='center', rotation='vertical')
plt.savefig('logisticregression_switchtrials_maineffects_cleaned_empirical.png', bbox_inches='tight',  dpi=300)
