...
gprew=np.load('gprews_empirical3.npy')

gppun=np.load('gppuns_empirical3.npy')

mbrew=np.load('mbrews_empirical3.npy')


mbpun=np.load('mbpuns_empirical3.npy')

mfrew=np.load('mfrews_empirical3.npy')


mfpun=np.load('mfpuns_empirical3.npy')
...
plt.savefig('logisticregression_switchtrialsf_empirical_cleaned2.png', bbox_inches='tight',  dpi=300)
...
plt.savefig('logisticregression_switchtrials_diffs_empirical_cleaned2.png', bbox_inches='tight',  dpi=300)
plt.show()
...
f.text(0.5, -.12, 'Parameter Estimate', ha='center')
f.text(0.0, 0.5, 'Density', va='center', rotation='vertical')
plt.savefig('logisticregression_switchtrials_maineffects_cleaned_empirical_withversion.png', bbox_inches='tight',  dpi=300)
